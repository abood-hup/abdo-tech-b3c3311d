...
const About = () => {
  ...
  const achievements = [
    ...
    { icon: Award, title: "سنوات خبرة", value: "5+" },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            <div className="space-y-6 animate-slide-up">
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  بدأت رحلتي في عالم البرمجة منذ أكثر من 5 سنوات، مدفوعاً بشغف حقيقي لحل المشاكل وبناء حلول تقنية تحدث فرقاً في حياة الناس والأعمال.
                </p>
                <p>
          ...
          <div className="mt-16 grid md:grid-cols-2 gap-12">
            <div className="card-professional p-8 animate-slide-up">
              ...
              <ul className="space-y-3 text-muted-foreground">
                <li>• بكالوريوس هندسة البرمجيات</li>
